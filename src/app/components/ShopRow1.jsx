...
export default function TopThree() {
  ...
  // Pick which products to feature (by slug)
  const TOP_SLUGS = useMemo(
    () => ['maybe-egypt-tshirt', 'kisses-to-valen-tshirt', 'only-names-tshirt', 'blue-valen-tshirt'],
    []
  );

  // Build products from centralized data
