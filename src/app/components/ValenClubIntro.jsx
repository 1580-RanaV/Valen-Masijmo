        ...
        <div className="w-full lg:w-1/3 flex items-center justify-center p-8 sm:p-10 lg:p-12">
          <div className="max-w-md text-center flex flex-col justify-center">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-10">
              The <span className="text-red-800 font-semibold">Valen Club</span> is not a community — it’s a gate. An inner circle built quietly around belief, taste, and patience. Entry is never requested; it is noticed. Within, pieces are not announced or displayed — they are offered, one to one, when the moment feels right. To be part of Valen Masijmo is to exist away from the ordinary rhythm of commerce. There are no drops, no deadlines — only presence. Each creation is made after acceptance, by hand, in silence. Fewer than ten in the world, meant to be worn, not owned.
            </p>

            <Link
              href="#"
              className="inline-block text-sm tracking-wide text-gray-900 hover:underline duration-300"
            >
              Join the waitlist
            </Link>
          </div>
